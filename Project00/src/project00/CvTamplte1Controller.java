 ...
 * @author areejbaw
 */
public class CvTamplte1Controller implements Initializable {
 String path ="C:\\Users\\koka_\\Desktop\\UQU\\7th semester\\APproject\\Audio\\click-on-mouse.mp3";
        ...
        /*MPane.setOnKeyPressed(new EventHandler<KeyEvent>() {
            ...
            public void handle(KeyEvent e) {
                if (e.getCode() == KeyCode.F) {
                    try {
                        Parent root;
                        root = FXMLLoader.load(CvTamplte1Controller.this.getClass().getResource("Export.fxml"));
    ...
    @FXML
    private void Back_to_CvMenu(ActionEvent event) throws IOException {
